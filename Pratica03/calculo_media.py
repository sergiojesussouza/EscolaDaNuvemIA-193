...
nota1 = float(input("Digite a primeira nota (N1): "))
nota2 = float(input("Digite a segunda nota (N2): "))
nota3 = float(input("Digite a terceira nota (N3): "))
nota4 = float(input("Digite a quarta nota (N4): "))
